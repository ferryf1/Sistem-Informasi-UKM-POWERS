...
@section('tittle', 'Create Testimonials')
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Create Testimonials</h1>
                </div>
                <!-- /.col -->
                <!-- /.col -->
            </div><!-- /.row -->
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nama" id="nama"
                                        value="{{ old('nama') }}" placeholder="Enter the Your Name" />
                                </div>
                                <div class="form-group">
                                    <label for="nama">Position</label>
                                    <input type="text" class="form-control" name="jabatan" id="nama"
                                        value="{{ old('jabatan') }}" placeholder="Enter the Your Position" />
                                </div>
                                <div class="form-group">
